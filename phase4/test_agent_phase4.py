...
def main():
    """
    Test script for Phase 4: Final Generalization Inference.
    We are loading the trained Phase 4 model, paired with our 
    bulletproofed VLM Semantic Parser, to drive autonomously.
    """
    print("🚗 Initializing CARLA-VLM Environment for PHASE 4 TEST...")
    env = CarlaVLMEnv()
    
    # 🧠 Load the Phase 4 Generalized model.
    model_path = "sac_carla_phase4_final"
    ...
    try:
        ...
        print("✅ Phase 4 Model loaded successfully for testing!")
    ...
    for ep in range(test_episodes):
        ...
        while not done:
            ...
            if "image" in info and info["image"]:
                ...
                cv2.putText(frame, f"PHASE 4 TEST - Ep: {ep + 1}/{test_episodes}", 
